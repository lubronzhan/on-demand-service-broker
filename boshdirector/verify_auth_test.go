...
var _ = Describe("verifying authentication credentials are correct", func() {
	...
	BeforeEach(func() {
		...
		directorClient, err = boshdirector.New("https://director.example.com", nil, fakeCertAppender, fakeDirectorFactory, fakeUAAFactory, boshAuthConfig, fakeDNSRetrieverFactory.Spy, fakeBoshHTTPFactory.Spy, logger)
